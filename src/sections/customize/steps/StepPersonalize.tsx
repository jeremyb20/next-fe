        ...
        <Stack spacing={2}>
          <Box>
            <Typography variant="body2" gutterBottom>
              Tamaño del nombre:{' '}
              {personalization.nameFontSize || personalization.fontSize || 36}px
            </Typography>
            <Slider
              value={
          ...
          <Box>
            ...
            <Slider
              value={
                personalization.phoneFontSize || personalization.fontSize || 36
              }
              onChange={(e, value) =>
                onPersonalizationChange({
                  ...personalization,
      ...
      <Paper variant="outlined" sx={{ p: 2 }}>
        ...
        <Stack spacing={2}>
          ...
          <FormControl fullWidth>
            ...
            <FormHelperText>
              {!personalization.strokeWidth || personalization.strokeWidth === 0
